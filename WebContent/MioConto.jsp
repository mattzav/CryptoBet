									...
									<div class="col-sm-6">
										<form method="post" action="login">
											...
											<div class="form-group">
												...
												<a class="btn btn-primary" href="Registrati.html" onclick="<c:set var="page" value="MioConto.jsp" scope="session"/>">Registrati</a>
											</div>
										</form>
									</div>
								</div>
						...
						<div class="col-md-12 schedule-container">
							...
							<div class="schedule-content active">
								<div class="col-md-3 col-sm-6">
									<div class="program program-schedule" onclick="effettuaVersamento()">
								...
								<div class="col-md-3 col-sm-6">
									<div class="program program-schedule" onclick="mostraUltimeScommesse()">
